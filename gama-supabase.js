...
(function(){
  ...
  window.GamaCloudReady=init().then(async()=>{
    const modules=['gama-cloud-auth.js?v=20','gama-cloud-products.js?v=19','gama-cloud-users.js?v=18','gama-purchases-supplier-bridge.js?v=6','gama-invoice-archive.js?v=3','gama-client-catalog.js?v=6','gama-customer-requests.js?v=3'];
