...
window.GamaCloudReady=init().then(function(){['gama-cloud-products.js?v=18','gama-cloud-auth.js?v=19','gama-cloud-users.js?v=17','gama-purchases-supplier-bridge.js?v=5','gama-invoice-archive.js?v=2','gama-client-catalog.js?v=5','gama-customer-requests.js?v=2','gama-menu-final2.js?v=8'].forEach(function(src){const s=document.createElement('script');s.src=src;s.async=true;document.head.appendChild(s)});return window.GamaCloud});
})();
