/* GAMA DEV V10 — registre des modules clients */
(()=>{
'use strict';
const MODULES=[
...
function load(){if(document.getElementById('gamaDevTilesLoader'))return;const s=document.createElement('script');s.id='gamaDevTilesLoader';s.src=location.origin+'/Pro-manager-Gama-DEV/gama-dev-tiles.js?v=20260831-0015';s.onload=()=>console.info('[GAMA DEV] V10 client tiles loaded');s.onerror=()=>console.warn('[GAMA DEV] V10 client tiles unavailable');document.body.appendChild(s)}
