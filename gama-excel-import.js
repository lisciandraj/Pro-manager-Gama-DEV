...
(function(){
  ...
  function section(){
    let s=$('gamaExcelImport');if(s)return s;
    s=document.createElement('section');s.id='gamaExcelImport';
  ...
  function loadXLSX(){
    ...
    return new Promise((resolve,reject)=>{const s=document.createElement('script');s.src=XLSX_URL;s.onload=()=>window.XLSX?resolve(window.XLSX):reject(new Error('XLSX indisponible'));s.onerror=reject;document.head.appendChild(s)})
  }
