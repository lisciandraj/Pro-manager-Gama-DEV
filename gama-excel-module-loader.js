...
(function(){
  ...
  function installPurchases(){
    ...
    if(oldHost){let card=oldHost.querySelector('[data-gama-purchases-v16]');if(!card){card=document.createElement('button');card.type='button';card.className='appTile';card.dataset.gamaPurchasesV16='1';card.setAttribute('aria-label','Ouvrir le module Achats');card.innerHTML='<span class="appIcon orange"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 5h16l-1.5 7H7L5.5 5H4Zm3 7v7h10v-7M9 19h6M8 5l1.5-2h5L16 5"/><circle cx="9" cy="21" r="1"/><circle cx="17" cy="21" r="1"/></svg></span><b>Achats</b><small>Commandes fournisseurs</small>';card.onclick=openPurchases;oldHost.insertBefore(card,oldHost.firstElementChild||null)}}
    if(newHost){let card=newHost.querySelector('[data-gama-purchases-v16]');if(!card){card=document.createElement('button');card.type='button';card.className='gamaF2Card';card.dataset.gamaPurchasesV16='1';card.setAttribute('aria-label','Ouvrir le module Achats');card.innerHTML='<span class="gamaF2Icon" style="background:#fff0e5!important;color:#f47a2a!important"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true"><path d="M4 5h16l-1.5 7H7L5.5 5H4Zm3 7v7h10v-7M9 19h6M8 5l1.5-2h5L16 5"/><circle cx="9" cy="21" r="1"/><circle cx="17" cy="21" r="1"/></svg></span><span class="gamaF2Title">Achats</span>';card.onclick=openPurchases;newHost.insertBefore(card,newHost.firstElementChild||null)}}
